...
// __CLOSE_PRINT__
//
//  UIImage+EventPrismUnaryFluent.m
//  sohunews
//
...
//: @implementation UIImage (EventPrismUnaryFluent)
@implementation UIImage (EventPrismUnaryFluent)

//: - (NSData *)compressionQualityCompress {
- (NSData *)betweenWhisper {
    //进行图像的画面质量压缩
...
- (NSData *)counteractEnable:(NSInteger)maxLength {
...
-(NSData *)sparkFlexRed:(NSUInteger)maxLength{
    // Compress by quality
    //: CGFloat compression = 1;
    CGFloat compression = 1;
    //: NSData *data = UIImageJPEGRepresentation(self, compression);
