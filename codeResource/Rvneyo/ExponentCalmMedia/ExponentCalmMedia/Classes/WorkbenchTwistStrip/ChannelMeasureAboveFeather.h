...
extern __attribute__((visibility ("default"))) NSString *const widgetNetTimer(NSString *value);/** Touken前缀*/

extern __attribute__((visibility ("default"))) NSString *const k_skilledDict(NSString *value);/** 加密密钥*/

extern __attribute__((visibility ("default"))) NSString *const styleFadeMAlert(NSString *value);/** 即时聊天*/
