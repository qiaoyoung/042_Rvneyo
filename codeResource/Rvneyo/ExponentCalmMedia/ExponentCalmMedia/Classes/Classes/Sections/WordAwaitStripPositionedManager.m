...
#define kWordAwaitStripPositionedManagerVersionKey @"kWordAwaitStripPositionedManagerVersionKey"
...
- (NSString *)calculateAppResPath {
    ...
    NSString *resDir = [docuPath stringByAppendingPathComponent:kExponentCalmMedia];
    ...
    NSString *fileResDir = [[docuPath stringByAppendingPathComponent:@"file"] stringByAppendingPathComponent:kExponentCalmMedia];
    ...
    NSString *path = [[InkwellValidateSplitShell sharedKit].emoticonBundle pathForResource:kExponentCalmMedia ofType:@".zip"];
    if (!path) {
