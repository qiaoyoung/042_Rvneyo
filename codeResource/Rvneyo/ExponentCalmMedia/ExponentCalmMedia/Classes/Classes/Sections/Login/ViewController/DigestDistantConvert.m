...
@interface DigestDistantConvert ()
...
@implementation DigestDistantConvert
...
-(void)commitButtonClick
{
    ...
    [ConfigPrimalCozy getWithUrl:Server_user_modifyPass params:dict isShow:YES success:^(id responseObject) {
