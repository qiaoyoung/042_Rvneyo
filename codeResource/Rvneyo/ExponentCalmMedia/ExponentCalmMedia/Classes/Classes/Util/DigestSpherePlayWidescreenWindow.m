...
{
    return [DigestSpherePlayWidescreenWindow filepathForDir:RDVideo
                                     filename:filename];
}

+ (NSString *)filepathForImage:(NSString *)filename
{
    return [DigestSpherePlayWidescreenWindow filepathForDir:RDImage
                                     filename:filename];
}

+ (NSString *)filepathForMergeForwardFile:(NSString *)filename {
    return [DigestSpherePlayWidescreenWindow filepathForDir:RDMerge
                                     filename:filename];
}
