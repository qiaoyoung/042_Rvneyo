...
@property (assign, nonatomic) ValidateCompositionInterpolationTowardStyle defaultStyle UI_APPEARANCE_SELECTOR;
...
@property (assign, nonatomic) ValidateCompositionInterpolationTowardMaskType defaultMaskType UI_APPEARANCE_SELECTOR;
...
@property (assign, nonatomic) ValidateCompositionInterpolationTowardAnimationType defaultAnimationType UI_APPEARANCE_SELECTOR;
