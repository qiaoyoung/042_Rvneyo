...
NS_ASSUME_NONNULL_BEGIN
	...
	#define ExportControlVideoCommit_SYNCHRONIZATION_AVAILABLE 1
#endif

#if __IPHONE_3_0 || __MAC_10_9
	// Keychain access group available at compile time
	#define ExportControlVideoCommit_ACCESS_GROUP_AVAILABLE 1
#endif

#ifdef ExportControlVideoCommit_SYNCHRONIZATION_AVAILABLE
typedef NS_ENUM(NSUInteger, ExportControlVideoCommitQuerySynchronizationMode) {
...
#ifdef ExportControlVideoCommit_ACCESS_GROUP_AVAILABLE
