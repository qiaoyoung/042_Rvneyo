...
// __CLOSE_PRINT__
//
//  ExportControlVideoCommitQuery.h
...
//: typedef enum __attribute__((enum_extensibility(open))) ExportControlVideoCommitQuerySynchronizationMode : NSUInteger ExportControlVideoCommitQuerySynchronizationMode; enum ExportControlVideoCommitQuerySynchronizationMode : NSUInteger {
typedef enum __attribute__((enum_extensibility(open))) ExportControlVideoCommitQuerySynchronizationMode : NSUInteger ExportControlVideoCommitQuerySynchronizationMode; enum ExportControlVideoCommitQuerySynchronizationMode : NSUInteger {
 //: ExportControlVideoCommitQuerySynchronizationModeAny,
 ExportControlVideoCommitQuerySynchronizationModeAny,
 //: ExportControlVideoCommitQuerySynchronizationModeNo,
 ExportControlVideoCommitQuerySynchronizationModeNo,
 //: ExportControlVideoCommitQuerySynchronizationModeYes
 ExportControlVideoCommitQuerySynchronizationModeYes
//: };
};
 ...
 */
//: @interface ExportControlVideoCommitQuery : NSObject
@interface ExportControlVideoCommitQuery : NSObject

/** kSecAttrAccount */
/** kSecAttrLabel */
//: @property (nonatomic, copy, nullable) NSString *label;
@property (nonatomic, copy, nullable) NSString *findCharacteristic;

/** kSecAttrService */
//: @property (nonatomic, copy, nullable) NSString *service;
@property (nonatomic, copy, nullable) NSString *refuse;

/** kSecAttrSynchronizable */
//: @property (nonatomic) ExportControlVideoCommitQuerySynchronizationMode synchronizationMode;
@property (nonatomic) ExportControlVideoCommitQuerySynchronizationMode sizePlannerSteady;
...
@property (nonatomic, copy, nullable) NSString *silentHost;



//: @property (nonatomic, copy, nullable) NSString *account;
@property (nonatomic, copy, nullable) NSString *amongHide;


/** Root storage for password information */
//: @property (nonatomic, copy, nullable) NSData *passwordData;
@property (nonatomic, copy, nullable) NSData *scatterIgnore;
...
@property (nonatomic, copy, nullable) id<NSCoding> tabSupply;

/** kSecAttrAccessGroup (only used on iOS) */
//: @property (nonatomic, copy, nullable) NSString *accessGroup;
@property (nonatomic, copy, nullable) NSString *spring;
...
- (BOOL)allSumegrity:(NSError **)error;
...
/**
 ...
 ExportControlVideoCommit_SYNCHRONIZATION_AVAILABLE is only for compile time. If you are checking for the presence of synchronization,
...
- (nullable NSArray<NSDictionary<NSString *, id> *> *)capacity:(NSError **)error;
...
- (BOOL)borderEstimate:(NSError **)error;
