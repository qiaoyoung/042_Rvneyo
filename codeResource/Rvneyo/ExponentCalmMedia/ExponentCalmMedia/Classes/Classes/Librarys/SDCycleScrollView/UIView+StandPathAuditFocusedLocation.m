...
// __CLOSE_PRINT__
//
//  UIView+StandPathAuditFocusedLocation.m
//  SDRefreshView
//
...
//: @implementation UIView (StandPathAuditFocusedLocation)
@implementation UIView (StandPathAuditFocusedLocation)
...
- (void)setMountain:(CGFloat)sd_height
{
    //: CGRect temp = self.frame;
    CGRect temp = self.frame;
