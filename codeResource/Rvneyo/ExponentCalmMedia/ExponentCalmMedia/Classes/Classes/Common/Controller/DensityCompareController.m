...
//        NSString *title  = item[TabbarTitle];
    ...
    navBar.barTintColor = [UIColor colorWithPatternImage:[FeatherInteractionGrand getLinearGradientImage:RGB_COLOR_String(kCommonBGColor_begin) and:RGB_COLOR_String(kCommonBGColor_end) directionType:FeatherInteractionGrandDirectionVertical]];
    [navBar setTitleTextAttributes:dic];
    [navBar setShadowImage:[UIImage new]];
    [navBar setBackgroundImage:[FeatherInteractionGrand getLinearGradientImage:RGB_COLOR_String(kCommonBGColor_begin) and:RGB_COLOR_String(kCommonBGColor_end) directionType:FeatherInteractionGrandDirectionLevel] forBarMetrics:UIBarMetricsDefault];
    ...
    if (_configs == nil)
    {
        _configs = @{
                     @(DensityCompareTypeMessageList) : @{
                             TabbarVC           : @"RealBrilliantPassiveVoyage",
                     ...
                     @(DensityCompareTypeChatroomList): @{
                             TabbarVC           : @"InstanceEmitterComposer",
                     ...
                     @(DensityCompareTypeSetting)     : @{
                             TabbarVC           : @"FluentInvalidatePaginate",
