...
{
    if(!_customAlbumView){
        _customAlbumView = [[FilterSelectSpirit alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)];
...
{
    if(!_audioContent){
        _audioContent = [[SpriteImportComposerFabricPerform alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)];
