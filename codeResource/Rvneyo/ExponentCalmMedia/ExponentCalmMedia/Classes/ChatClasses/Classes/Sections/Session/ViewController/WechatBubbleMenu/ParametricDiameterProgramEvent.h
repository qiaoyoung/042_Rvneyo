//
//  ParametricDiameterProgramEvent.h
//  JYImageTextCombine
//
...
@interface ParametricDiameterProgramEvent : UIView
...
- (void)showViewWithButtonModels:(NSArray *)array
                 cursorStartRect:(CGRect)cursorStartRect selectionTextRectInWindow:(CGRect)rect selectBlock:(void(^)(AnchorFocalHandlerDividerWall *item))block
