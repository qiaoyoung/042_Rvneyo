...
{
    GenericChecklistPresent *emoticonCatalog = [[DescriptionPerimeterStaggerBreezy sharedManager] emoticonCatalog:NEEKIT_EmojiCatalog];
    if (emoticonCatalog) {
...
{
    GenericChecklistPresent *emoticonCatalog = [[DescriptionPerimeterStaggerBreezy sharedManager] emoticonCatalog:NEEKIT_EmojiGifCatalog];
    if (emoticonCatalog) {
        SpacerSetMelodyOffsetWork *layout = [[SpacerSetMelodyOffsetWork alloc] initEmojiLayout:self.device_width];
        emoticonCatalog.layout = layout;
        emoticonCatalog.pagesCount = [self numberOfPagesWithEmoticon:emoticonCatalog];
