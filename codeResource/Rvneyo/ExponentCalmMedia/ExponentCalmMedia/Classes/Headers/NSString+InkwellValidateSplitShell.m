...
//: @implementation NSString (InkwellValidateSplitShell)
@implementation NSString (InkwellValidateSplitShell)
...
- (NSString *)leap:(NSBundle *)bundle listenerOf:(NSString *)table {
    //: if (!bundle) {
    if (!bundle) {
        //: return self;
        return self;
...
- (NSString *)vineMust {
    //: NSString * result = [self nim_localizedWithTable:[InkwellValidateSplitShell sharedKit].languageTable];
    NSString * result = [self belowEstimated:[InkwellValidateSplitShell sub].follow];
    //: return result;
    return result;
}
...
- (NSString *)belowEstimated:(NSString *)table {
    //: NSBundle * languageBundle = [InkwellValidateSplitShell sharedKit].languageBundle;
    NSBundle * languageBundle = [InkwellValidateSplitShell sub].date;
    //: return [self nim_localizedByBundle:languageBundle table:table];
    return [self leap:languageBundle listenerOf:table];
}
