...
//: @implementation UnlockPlazaTrustCompositionOnto
@implementation UnlockPlazaTrustCompositionOnto
//: - (BOOL)shouldIgnoreMessage:(NIMMessage *)message
- (BOOL)shouldIgnoreMessage:(NIMMessage *)message
{
    //: NIMMessageType type = [CertificateConnectBadgeMediatorStoryboard sharedConfig].ignoreMessageType;
    NIMMessageType type = [CertificateConnectBadgeMediatorStoryboard grain].giftedHorizon;
...
- (BOOL)shouldIgnoreNotification:(NIMNotificationObject *)notification
{
    ...
    {
        //: NSArray *types = [[CertificateConnectBadgeMediatorStoryboard sharedConfig] ignoreTeamNotificationTypes];
        NSArray *types = [[CertificateConnectBadgeMediatorStoryboard grain] runFlow];
