...
// __CLOSE_PRINT__
//
//  WriteTrianglesInfrastructureAllocate.h
...
//: @interface WriteTrianglesInfrastructureAllocate : UIViewController<ConverterDuneRouteValidation,NeatTopmostFind,OntoFlashNamespaceSearch,NIMChatManagerDelegate,NIMConversationManagerDelegate,NIMChatExtendManagerDelegate>
@interface WriteTrianglesInfrastructureAllocate : UIViewController<ConverterDuneRouteValidation,NeatTopmostFind,OntoFlashNamespaceSearch,NIMChatManagerDelegate,NIMConversationManagerDelegate,NIMChatExtendManagerDelegate>

//: @property (nonatomic,assign) BOOL canSendText; 
@property (nonatomic,assign) BOOL spectrumBecome;// 能够点击语音按钮
...
@property (nonatomic, strong, readonly) UILabel *reach;

//: @property (nonatomic,weak) id<SummarizeTriggerAfter> interactor;
@property (nonatomic,weak) id<SummarizeTriggerAfter> make;
/**
 *  会话页主标题
 *
...
@property (nonatomic, strong, readonly) UILabel *honestByConsistent;
...
//: @property (nonatomic, strong) DereferenceConstructComposite *sessionInputView;
@property (nonatomic, strong) DereferenceConstructComposite *bare;
...
@property (nonatomic, strong, readonly) NIMMessage *stern;

//: @property (nonatomic,strong) NIMSession *session;
@property (nonatomic,strong) NIMSession *magnitudeContrast;
/**
 * 跳转到对应消息
 */
...
@property (nonatomic,assign) BOOL outside;//是否通知群消息

//: @property (nonatomic,strong) NSDictionary *teamSettingConfig;
@property (nonatomic,strong) NSDictionary *north;

//: @property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) UITableView *child;
